...
function App() {
  ...
  const fetchItems = () => {
    fetch(
      "https://bookstore-ad841-default-rtdb.europe-west1.firebasedatabase.app/books.json"
    )
  ...
  const deleteBook = (id) => {
    fetch(
      `https://bookstore-ad841-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`,
      {
        method: "DELETE",
      }
    )
